...
/**
PIP Streamer main class to handle all 
 */
const PIPoptions = {

    appId: "81d99d5bc7ad4117a6023f4128abdb1f",
    channel: "volcanohomeXoioWE",
    token: null,
}
...
class PipStream
{
    constructor(props)
    {
        ...
        this.watchonlymode = props.watchonlymode || true;

        //Callback when the agora is initialised
        this.onInitialised = props.onInitialised || function(){};

        //Callback when the agora is initialised
        this.onStreamerConnectSuccess= props.onStreamerConnectSuccess || function(){};
    ...
    //Old handle join is replaced with inite
    init = (channelinput=false) =>  {
        ...
        let systemStatus = CoreRTC.checkSystemRequirements();
        ...
        this.streamerClient =  CoreRTC.createClient({
   ...
   /*
   Function to handle changing an audien to host (handleChangeToHost)
   */
   enableCamera = (custom_uuid = this.uuid) => {
    ...
    handleClientConnectSuccess = (bounced_uuid) => {
            ...
            this.localStream = CoreRTC.createStream({
    ...
    startLiveStreaming = () => {
            ...
            const LiveTranscoding = {
                    ...
                    videoFramerate: 60,
                    audioSampleRate: CoreRTC.AUDIO_SAMPLE_RATE_48000,
                    audioBitrate: 48,
                    audioChannels: 1,
                    videoGop: 30,
                    ...
                    videoCodecProfile: CoreRTC.VIDEO_CODEC_PROFILE_HIGH,
                    userCount: 1,
                    userConfigExtraInfo: {},
                    ...
                    transcodingUsers: [{
                            ...
                            zOrder: 0,
                            alpha: 1.0,
                            // The uid must be identical to the uid used in CoreRTCClient.join.
    ...
    shareScreen = () => {
        ...
        this.screenShareStream = CoreRTC.createStream({
